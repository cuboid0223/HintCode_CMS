 ...
 * @category Firebase
 */
export declare function FirebaseLoginView({ allowSkipLogin, logo, signInOptions, firebaseApp, authController, noUserComponent, disableSignupScreen, disabled, additionalComponent, notAllowedError }: FirebaseLoginViewProps): import("react/jsx-runtime").JSX.Element;
